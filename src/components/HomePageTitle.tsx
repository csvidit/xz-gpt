...
const HomePageTitle = (props: { user: UserProfile | undefined }) => {
  return (
    <div className="flex flex-col space-y-5 lg:w-1/6 text-neutral-100">
      <div className="text-lg lg:text-xl capitalize w-fit">
        Welcome, {props.user?.nickname}
      </div>
      <div className="flex flex-col space-y-2.5 rounded-2xl p-5 py-2.5 bg-neutral-900 border border-neutral-800 bg-opacity-40 w-full h-fit">
